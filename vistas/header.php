...
<html>
  <head>
    ...
    <link rel="stylesheet" href="../public/css/scroller.dataTables.min.css">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="escritorio.php" class="logo">
          ...
          <span class="logo-lg"><b>Orange SF</b></span>
        </a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="../ajax/usuario.php?op=salir" class="btn btn-default btn-flat">Logut</a>
                    </div>
                    <div class="pull-right">
                      <a href="cambiar_contraseña.php" class="btn btn-default btn-flat">Contraseña</a>
                    </div>
                    <div class="pull-left">
                      <a href="timeline_actividad.php" class="btn btn-default btn-flat">Registro</a>
                    </div>
                  </li>
                </ul>
              </li>
          ...
          <ul class="sidebar-menu">
            ...
            if ($_SESSION['almacen']==1)
            {
              echo '<li class="treeview">
                    ...
                    <span>Control Botellas</span>
                    <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                    <li><a href="botella.php"><i class="fa fa-circle-o"></i> Botellas</a></li>
...
-->
                  ...
                  if ($_SESSION['configuracion']==1)
                  {
                    echo '<li class="treeview">
                      ...
                      <ul class="treeview-menu">
                        <li><a href="#"><i class="fa fa-circle-o"></i>Maestro Almacén</a></li>
                        <li><a href="#"><i class="fa fa-circle-o"></i>Tipo Movimientos</a></li>
