...
public function cambiar_contraseña($idusuario,$contraseña,$nueva_contraseña)
{
$sql="UPDATE usuario SET clave='$nueva_contraseña'where idusuario='$idusuario'";
...
return ejecutarConsulta($sql);
  ...
  public function editar($idusuario,$nombre,$tipo_documento,$num_documento,$direccion,$telefono,$email,$cargo,$login,$clave,$imagen,$permisos)
  {
   ...
   //Eliminamos todos los permisos asignados para volverlos a registrar
		...
		$num_elementos=0;
		$sw=true;
    //validamos si el array con permisos esta definido o es null
    if (isset($permisos)) {
      while ($num_elementos < count($permisos))
      {
